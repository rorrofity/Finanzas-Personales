...
0. 🚧 **Sincronización Automática Programada + Push (Epic 13)** — *épica actual, especificada el 2026-07-19*: scheduler backend (node-cron, 13:00 y 22:00 America/Santiago) que dispara la sync de N8N automáticamente (opt-in por dueño) y envía notificación push (Web Push/VAPID) cuando trae transacciones nuevas, para recordar categorizar. Enmienda constitucional 1.2 (N8N-001 ahora permite sync programada) + principio PUSH-001. Ver spec.md Epic 13, plan.md v4, tasks.md v4.
